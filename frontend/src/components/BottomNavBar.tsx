  ...
  return (
    <nav className="fixed bottom-0 left-0 z-50 flex h-20 w-full items-center justify-around bg-[#141414] pb-safe shadow-[0_-10px_30px_rgba(0,0,0,0.5)] lg:hidden">
      <button
        ...
        className={`flex flex-col items-center gap-1 transition-transform active:scale-90 ${activeTab === 'chat' ? 'text-[#4f98a3]' : 'text-zinc-500'}`}
      >
      ...
      <button
        ...
        className={`flex flex-col items-center gap-1 transition-transform active:scale-90 ${activeTab === 'graph' ? 'text-[#4f98a3]' : 'text-zinc-500'}`}
      >
